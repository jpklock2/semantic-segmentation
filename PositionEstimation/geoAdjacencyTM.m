...
if R == 0
    ...
    name = ['Images\Dataset_BR\Correlation_Matrices\img_' num2str(imgCnt, '%05.f') '.mat'];
end
...
%         resultsMatrix{ponY, ponX}.corr = max(corrMat(:));
        ...
        save(['Temp\img_' num2str(imgCnt, '%05.f') '.mat'], 'posMatrix', 'resultsMatrix', 'pX', 'pY', 'ponY', 'ponX', 'BW_Template', 'cropSize');
