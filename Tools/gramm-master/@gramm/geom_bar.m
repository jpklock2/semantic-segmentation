...
my_addParameter(p,'FaceAlpha',1);
my_addParameter(p,'EdgeAlpha',1);
...
if strcmp(params.FaceAlpha,'auto')
    FaceAlpha=draw_data.color;
else
...
if strcmp(params.EdgeAlpha,'auto')
    EdgeAlpha=draw_data.color;
else
    EdgeAlpha=params.EdgeAlpha;
end
