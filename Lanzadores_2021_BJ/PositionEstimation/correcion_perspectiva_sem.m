function [img_out, util_img, utilCropSize]=correcion_perspectiva_sem(img, yaw, pitch, roll, distz, pre_geo_img, pre_uav_img, perspective_correction_type, printFigs, preprocessing_img)
